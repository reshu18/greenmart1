...
function Homepage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      imageURL:
        "https://tse1.mm.bing.net/th?id=OIP.uxO0t3yE8HhlCC6USZQPswHaFd&pid=Api&rs=1&c=1&qlt=95&w=128&h=94",
    },
    {
      name: "Baby Products",
      imageURL:
        "https://tse3.mm.bing.net/th?id=OIP.wS1-ouWAw9ARReNVrHXxagHaE8&pid=Api&P=0",
    },
  ];
